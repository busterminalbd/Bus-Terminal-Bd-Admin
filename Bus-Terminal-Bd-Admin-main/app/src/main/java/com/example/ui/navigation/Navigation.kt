...
sealed class Screen(val route: String, val titleBn: String, val icon: ImageVector, val selectedIcon: ImageVector) {
    ...
    object Buses : Screen("buses", "বাস ব্যবস্থাপনা", Icons.Outlined.DirectionsBus, Icons.Filled.DirectionsBus)
