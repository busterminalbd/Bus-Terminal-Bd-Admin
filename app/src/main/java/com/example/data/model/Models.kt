...
data class Fare(
    ...
    companion object {
        fun fromJson(json: JSONObject, busName: String = "", routeTitle: String = ""): Fare = Fare(
            ...
            busId = json.optString("bus_id", ""),
            routeId = json.optString("route_id", ""),
            fareAmount = json.optDouble("fare_amount", json.optDouble("amount", 0.0)),
            fareType = json.optString("fare_type", "Regular"),
            effectiveDate = json.optString("effective_date", ""),
...
data class TourPackage(
    ...
    companion object {
        fun fromJson(json: JSONObject): TourPackage = TourPackage(
            ...
            fullDescription = json.optString("full_description", ""),
...
data class Booking(
    ...
    companion object {
        fun fromJson(json: JSONObject): Booking = Booking(
            id = json.optString("id", ""),
            bookingId = json.optString("booking_id", "BK-${json.optString("id").take(6).uppercase()}"),
